...
$fid=$_POST["fid"];
$fid=$fid%1000;
$sql="delete from friends where id=$id and fid=$fid";
$result=mysqli_query($conn,$sql);
#$sql="insert into friends(id,fid) values($fid,$id)";
$sql="delete from friends where id=$fid and fid=$id";

$result1=mysqli_query($conn,$sql);
#$sql="delete from requests where id=$id and fid=$fid";
#$result2=mysqli_query($conn,$sql);
#$sql="delete from requests where id=$fid and fid=$id";
#$result3=mysqli_query($conn,$sql);


if($result && $result1){
echo "unfriend success<br>";
}
else{
echo "something went wrong!!";
}
#echo "<font color='darkgreen' <br>friend requests to display<br><br>";
...
echo "$id && $fn <br>"; */
$iid=$row["id"];
echo "<tr><td>".$row["id"]."</td><td>".$row["fname"]."</td><td>".$row["$sort"]."</td><td><form action='add_friend.php' method='POST'>
...
echo "<font color='black'>find friends";
